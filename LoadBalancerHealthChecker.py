...
def lambda_handler(event, context):
    ...
    elb_name = 'arn:aws:elasticloadbalancing:ap-south-1:295397358094:targetgroup/CharanHealthCheckTG/6a98b973f8a50200'
    ...
    if unhealthy_instances:
        ...
        sns_topic_arn = 'arn:aws:sns:ap-south-1:295397358094:Charan_SNS'
